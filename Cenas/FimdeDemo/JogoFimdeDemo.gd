...
func _ready():
	...
	global.cena = "res://Cenas/FimdeDemo/JogoFimdeDemo.tscn"
	...
	cardTextE="Ir Para o Menu Principal" #Texto quando o jogador por o mouse no lado ESQUERDO (ponha entre aspas "")
	trocaCenaE="res://Cenas/Menu/Menu.tscn" #Para que cena o jogador vai se escolher o lado ESQUERDO (ponha entre aspas "")
	cardTextD="Ir Para o Menu Principal" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
