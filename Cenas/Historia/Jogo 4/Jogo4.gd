...
func _ready():
	...
	global.cena = "res://Cenas/Historia/Jogo 4/Jogo4.tscn" #aqui se põe o caminho para essa cena no jogo
	...
	cardTextE="'Certo...'" #Texto quando o jogador por o mouse no lado ESQUERDO (ponha entre aspas "")
	...
	cardTextD="'Vamos comer antes!'" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
