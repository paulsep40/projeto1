...
###########################################################
	...
	global.cena = "res://Cenas/Historia/Jogo 53/Jogo53.tscn" #aqui se põe o caminho para essa cena no jogo
	...
	cardTextE="'Oh não'" #Texto quando o jogador por o mouse no lado ESQUERDO (ponha entre aspas "")
	...
	cardTextD="'Oh não'" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
