...
###########################################################
	...
	global.cena = "res://Cenas/Historia/Jogo 75/Jogo75.tscn" #aqui se põe o caminho para essa cena no jogo
	...
	cardTextE="Defender" #Texto quando o jogador por o mouse no lado ESQUERDO (ponha entre aspas "")
	trocaCenaE="res://Cenas/Historia/Jogo 76/Jogo76.tscn" #Para que cena o jogador vai se escolher o lado ESQUERDO (ponha entre aspas "")
	cardTextD="Atacar" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 80/Jogo80.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
