...
func _ready():
	...
	trocaCenaE="res://Cenas/FimdeDemo" #Para que cena o jogador vai se escolher o lado ESQUERDO (ponha entre aspas "")
	cardTextD="'Vou Defende-lo'" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/FimdeDemo" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
