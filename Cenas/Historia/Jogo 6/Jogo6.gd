...
func _ready():
	...
	global.cena = "res://Cenas/Historia/Jogo 6/Jogo6.tscn"
	...
	cardTextE="Levantar" #Texto quando o jogador por o mouse no lado ESQUERDO (ponha entre aspas "")
	...
	cardTextD="Levantar" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 7/Jogo7.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
