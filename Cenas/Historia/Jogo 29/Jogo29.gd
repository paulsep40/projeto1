...
func _ready():
	...
	global.cena="res://Cenas/Historia/Jogo 29/Jogo29.tscn"
	...
	cardTextD="Sair do treino" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 30/Jogo30.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
