...
func _ready():
	...
	global.cena = "res://Cenas/Historia/Jogo 72/Jogo72.tscn" #aqui se põe o caminho para essa cena no jogo
	...
	cardTextE="'Pelo meu irmão'" #Texto quando o jogador por o mouse no lado ESQUERDO (ponha entre aspas "")
	trocaCenaE="res://Cenas/Historia/Jogo 73/Jogo73.tscn" #Para que cena o jogador vai se escolher o lado ESQUERDO (ponha entre aspas "")
	cardTextD="'Acho que sim'" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 73/Jogo73.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
