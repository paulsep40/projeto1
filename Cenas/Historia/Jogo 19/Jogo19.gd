...
###########################################################
	...
	trocaCenaE="res://Cenas/Historia/Jogo 20/Jogo20.tscn" #Para que cena o jogador vai se escolher o lado ESQUERDO (ponha entre aspas "")
	cardTextD="Continuar" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 20/Jogo20.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
