...
###########################################################
	...
	cardTextE="’Ela é maravilhosa’" #Texto quando o jogador por o mouse no lado ESQUERDO (ponha entre aspas "")
	trocaCenaE="res://Cenas/Historia/Jogo 49/Jogo49.tscn" #Para que cena o jogador vai se escolher o lado ESQUERDO (ponha entre aspas "")
	cardTextD="’Muito obrigada’" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 49/Jogo49.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
