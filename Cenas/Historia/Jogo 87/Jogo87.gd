...
###########################################################
	...
	global.cena = "res://Cenas/Historia/Jogo 87/Jogo87.tscn" #aqui se põe o caminho para essa cena no jogo
	...
	cardTextD="'Prove quem é'" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 88/Jogo88.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
