...
func _ready():
	...
	global.cena = "res://Cenas/Historia/Jogo 69/Jogo69.tscn" #aqui se põe o caminho para essa cena no jogo
	global.capituloAtual=4 #Aqui coloque o ponto da jornada em que o jogador está
	...
	cardTextE="’Elementos essenciais?’" #Texto quando o jogador por o mouse no lado ESQUERDO (ponha entre aspas "")
	trocaCenaE="res://Cenas/Historia/Jogo 70/Jogo70.tscn" #Para que cena o jogador vai se escolher o lado ESQUERDO (ponha entre aspas "")
	cardTextD="’Só quero salvar meu irmão’" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 71/Jogo71.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
