...
func _ready():
	...
	global.cena = "res://Cenas/Historia/Jogo 62/Jogo62.tscn" #aqui se põe o caminho para essa cena no jogo
	...
	cardTextE="’Meu irmão...’" #Texto quando o jogador por o mouse no lado ESQUERDO (ponha entre aspas "")
	trocaCenaE="res://Cenas/Historia/Jogo 63/Jogo63.tscn" #Para que cena o jogador vai se escolher o lado ESQUERDO (ponha entre aspas "")
	cardTextD="’Não tenho tempo’" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 64/Jogo64.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
