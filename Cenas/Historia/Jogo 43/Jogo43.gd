...
###########################################################
	...
	global.cena = "res://Cenas/Historia/Jogo 43/Jogo43.tscn" #aqui se põe o caminho para essa cena no jogo
	...
	cardTextD="'Posso ajudar?'" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 44/Jogo44.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
