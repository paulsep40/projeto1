...
###########################################################
	...
	global.cena="res://Cenas/Historia/Jogo 25/Jogo25.tscn"
	...
	trocaCenaE="res://Cenas/Historia/Jogo 25/Jogo25.tscn" #Para que cena o jogador vai se escolher o lado ESQUERDO (ponha entre aspas "")
	cardTextD="Esperar e analisar a situação" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 24/Jogo24.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
