...
###########################################################
	...
	global.cena = "res://Cenas/Historia/Jogo 11/Jogo11.tscn"
	...
	cardTextE="'Calma! Quem é seu filho?'" #Texto quando o jogador por o mouse no lado ESQUERDO (ponha entre aspas "")
	trocaCenaE="res://Cenas/Historia/Jogo 13/Jogo13.tscn" #Para que cena o jogador vai se escolher o lado ESQUERDO (ponha entre aspas "")
	cardTextD="'Não! Me solte!'" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 12/Jogo12.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
