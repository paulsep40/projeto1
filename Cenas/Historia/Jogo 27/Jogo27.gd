...
func _ready():
	...
	global.cena="res://Cenas/Historia/Jogo 27/Jogo27.tscn"
	...
	trocaCenaE="res://Cenas/Historia/Jogo 29/Jogo29.tscn" #Para que cena o jogador vai se escolher o lado ESQUERDO (ponha entre aspas "")
	cardTextD="Esperar e analisar a situação" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 28/Jogo28.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
