...
###########################################################
	...
	global.cena = "res://Cenas/Historia/Jogo 23/Jogo23.tscn"
	...
	cardTextE="Esperar e analisar a situação" #Texto quando o jogador por o mouse no lado ESQUERDO (ponha entre aspas "")
	trocaCenaE="res://Cenas/Historia/Jogo 24/Jogo24.tscn" #Para que cena o jogador vai se escolher o lado ESQUERDO (ponha entre aspas "")
	cardTextD="Atacar" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 25/Jogo25.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
