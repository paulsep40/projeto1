...
func _ready():
	...
	global.cena = "res://Cenas/Historia/Jogo 74/Jogo74.tscn" #aqui se põe o caminho para essa cena no jogo
	...
	cardTextE="ignorar" #Texto quando o jogador por o mouse no lado ESQUERDO (ponha entre aspas "")
	...
	cardTextD="Examinar" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 75/Jogo75.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
