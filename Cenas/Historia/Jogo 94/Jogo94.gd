...
###########################################################
	...
	global.cena = "res://Cenas/Historia/Jogo 94/Jogo94.tscn" #aqui se põe o caminho para essa cena no jogo
	...
	cardTextE="'Tudo bem'" #Texto quando o jogador por o mouse no lado ESQUERDO (ponha entre aspas "")
	trocaCenaE="res://Cenas/Historia/Jogo 95/Jogo95.tscn" #Para que cena o jogador vai se escolher o lado ESQUERDO (ponha entre aspas "")
	cardTextD="'Não posso'" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 96/Jogo96.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
