...
func _ready():
	...
	global.cena = "res://Cenas/Historia/Jogo 31/Jogo31.tscn" #aqui se põe o caminho para essa cena no jogo
	...
	cardTextD="Ir para torre de vigia" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
