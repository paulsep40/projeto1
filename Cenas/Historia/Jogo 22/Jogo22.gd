...
func _ready():
	...
	global.cena="res://Cenas/Historia/Jogo 22/Jogo22.tscn"
	...
	cardTextE="’Pode repetir?’" #Texto quando o jogador por o mouse no lado ESQUERDO (ponha entre aspas "")
	trocaCenaE="res://Cenas/Historia/Jogo 17/Jogo17.tscn" #Para que cena o jogador vai se escolher o lado ESQUERDO (ponha entre aspas "")
	cardTextD="’Vamos lá’" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 23/Jogo23.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
