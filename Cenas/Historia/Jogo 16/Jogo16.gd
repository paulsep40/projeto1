...
###########################################################
	...
	global.cena = "res://Cenas/Historia/Jogo 16/Jogo16.tscn"
	...
	cardTextE="'Hoje não…' (pular tutorial)" #Texto quando o jogador por o mouse no lado ESQUERDO (ponha entre aspas "")
	trocaCenaE="res://Cenas/Historia/Jogo 33/Jogo33.tscn" #Para que cena o jogador vai se escolher o lado ESQUERDO (ponha entre aspas "")
	cardTextD="'Vamos lá!'" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 17/Jogo17.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
