...
###########################################################
	...
	global.cena = "res://Cenas/Historia/Jogo 14/Jogo14.tscn"
	...
	cardTextE="'Não tenho tempo pra isso'" #Texto quando o jogador por o mouse no lado ESQUERDO (ponha entre aspas "")
	trocaCenaE="res://Cenas/Historia/Jogo 15/Jogo15.tscn" #Para que cena o jogador vai se escolher o lado ESQUERDO (ponha entre aspas "")
	cardTextD="'Vou perguntar'" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 16/Jogo16.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
