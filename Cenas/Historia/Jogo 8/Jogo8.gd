...
func _ready():
	...
	global.cena = "res://Cenas/Historia/Jogo 8/Jogo8.tscn"
	...
	cardTextE="Ir para a vila" #Texto quando o jogador por o mouse no lado ESQUERDO (ponha entre aspas "")
	trocaCenaE="res://Cenas/Historia/Jogo 10/Jogo10.tscn" #Para que cena o jogador vai se escolher o lado ESQUERDO (ponha entre aspas "")
	cardTextD="Ir para a vila" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 10/Jogo10.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
