...
###########################################################
	...
	global.cena = "res://Cenas/Historia/Jogo 12/Jogo12.tscn"
	...
	cardTextE="'Eu sinto muito...'" #Texto quando o jogador por o mouse no lado ESQUERDO (ponha entre aspas "")
	trocaCenaE="res://Cenas/Historia/Jogo 14/Jogo14.tscn" #Para que cena o jogador vai se escolher o lado ESQUERDO (ponha entre aspas "")
	cardTextD="'Como posso ajudar?'" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 14/Jogo14.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
	...
	get_node("TrofeuArquetipo/LabelArquetipo").set_text("Arquétipo encontrado: Arauto") #Mude para o nome do arquétipo que o usuário encontrou
