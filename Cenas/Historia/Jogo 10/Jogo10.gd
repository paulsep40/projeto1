...
func _ready():
	...
	cardTextE="Tentar passar escondida" #Texto quando o jogador por o mouse no lado ESQUERDO (ponha entre aspas "")
	trocaCenaE="res://Cenas/Historia/Jogo 11/Jogo11.tscn" #Para que cena o jogador vai se escolher o lado ESQUERDO (ponha entre aspas "")
	cardTextD="Se aproximar" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 11/Jogo11.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
