...
###########################################################
	...
	global.cena = "res://Cenas/Historia/Jogo 76/Jogo76.tscn" #aqui se põe o caminho para essa cena no jogo
	...
	cardTextE="Atacar" #Texto quando o jogador por o mouse no lado ESQUERDO (ponha entre aspas "")
	trocaCenaE="res://Cenas/Historia/Jogo 78/Jogo78.tscn" #Para que cena o jogador vai se escolher o lado ESQUERDO (ponha entre aspas "")
	cardTextD="Analisa" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 77/Jogo77.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
