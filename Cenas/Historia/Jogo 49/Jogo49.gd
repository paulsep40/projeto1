...
func _ready():
	...
	global.cena = "res://Cenas/Historia/Jogo 49/Jogo49.tscn" #aqui se põe o caminho para essa cena no jogo
	...
	cardTextE="Tomar banho" #Texto quando o jogador por o mouse no lado ESQUERDO (ponha entre aspas "")
	trocaCenaE="res://Cenas/Historia/Jogo 50/Jogo50.tscn" #Para que cena o jogador vai se escolher o lado ESQUERDO (ponha entre aspas "")
	cardTextD="Treinar com a espada" #Texto quando o jogador por o mouse no DIREITO (ponha entre aspas "")
	trocaCenaD="res://Cenas/Historia/Jogo 50/Jogo50.tscn" #Para que cena o jogador vai se escolher o lado DIREITO (ponha entre aspas "")
